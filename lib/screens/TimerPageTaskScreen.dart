...
class TimerPageTaskScreen extends StatefulWidget {

  final Task task;

  TimerPageTaskScreen(this.task);
  @override
  _TimerPageTaskScreenState createState() => _TimerPageTaskScreenState();
}

class _TimerPageTaskScreenState extends State<TimerPageTaskScreen> {

  deleteTask(String id)async{
    try{
     await Dialogs.shared.deleteTaskDialog(context, id,  ()async{
                    try{
                      await Provider.of<TodayProvider>(context,listen:false).deleteTask(id,formateDate(DateTime.now()));
